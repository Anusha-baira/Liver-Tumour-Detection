...
main = tkinter.Tk()
main.title("liver cancer Detection using Image Processing") #designing main screen
...
font = ('times', 16, 'bold')
title = Label(main, text='liver cancer Detection using Image Processing', justify=LEFT)
